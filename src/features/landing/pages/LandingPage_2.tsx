            ...
            <div className="flex-1 space-y-2">
                {assets.map((asset, index) => (
                    <div key={index} className="flex items-center justify-between bg-zinc-800/50 rounded-lg p-3">
                        <div className="flex items-center gap-2">
                            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${asset.symbol === 'BTC' ? 'bg-orange-500' :
                ...
                <FadeInSection>
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-xl text-black/70 mb-12 max-w-2xl mx-auto">
                            Join thousands of traders who trust IKH MIYANGAN for secure and efficient digital asset trading.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link to="/register">
