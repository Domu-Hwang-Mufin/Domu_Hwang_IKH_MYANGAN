                    ...
                    <div className="flex justify-center gap-2 mb-12 flex-wrap">
                        {products.map((product, index) => (
                            <button
                                ...
                                className={`px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 ${activeProduct === index
                    ...
                    <GlassCard className="p-12 md:p-20 text-center relative overflow-hidden" hover={false}>
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-white/50 max-w-xl mx-auto mb-10 text-lg leading-relaxed">
                                Join thousands of traders who trust IKH MIYANGAN for secure and efficient digital asset trading. Create your account in minutes.
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <Link to="/register">
        ...
        <footer className="py-12 px-6 border-t border-white/5">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="flex items-center gap-2">
                    <span className="text-xl font-bold text-white">IKH MIYANGAN</span>
                </div>
                <p className="text-white/30 text-sm">
                    © 2026 IKH MIYANGAN. All rights reserved.
                </p>
